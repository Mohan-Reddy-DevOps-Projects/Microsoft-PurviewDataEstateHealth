...
internal class BusinessDomainCriticalDataElementAssignmentDomainModel : DomainModel
{
    public override string FolderPath => DataEstateHealthConstants.SOURCE_DOMAIN_MODEL_FOLDER_PATH + "/BusinessDomainCriticalDataElementAssignment";
