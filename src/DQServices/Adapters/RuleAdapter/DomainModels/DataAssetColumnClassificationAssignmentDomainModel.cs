...
internal class DataAssetColumnClassificationAssignmentDomainModel : DomainModel
{
    public override string FolderPath => DataEstateHealthConstants.SOURCE_DOMAIN_MODEL_FOLDER_PATH + "/DataAssetColumnClassificationAssignment";
