...
internal class DataQualityRuleColumnExecutionDomainModel : DomainModel
{
    public override string FolderPath => DataEstateHealthConstants.SOURCE_DOMAIN_MODEL_FOLDER_PATH + "/DataQualityRuleColumnExecution";
    ...
    public override List<DatasetSchemaItemWrapper> Schema => this._schema ??= SchemaUtils.GenerateSchemaFromDefinition([
        ["DataAssetId", "String"],
        ["ColumnResultScore", "Number", "false"]
    ]);
}
