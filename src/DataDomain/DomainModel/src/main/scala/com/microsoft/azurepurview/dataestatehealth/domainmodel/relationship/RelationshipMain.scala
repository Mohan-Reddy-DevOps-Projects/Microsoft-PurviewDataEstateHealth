  ...
  def main(args: Array[String],spark:SparkSession,ReProcessingThresholdInMins:Int): Unit = {
    try{
      ...
      if (args.length >= 5 && coldStartSoftCheck.validateCheckIn(args(0),"relationship")) {
        ...
        writer.overWriteData(df_processRelationship,adlsTargetDirectory,"Relationship",ReProcessingThresholdInMins)
        ...
        writer.overWriteData(df_glossaryTermDataProductAssignmentProcessed,adlsTargetDirectory,"GlossaryTermDataProductAssignment",ReProcessingThresholdInMins)
