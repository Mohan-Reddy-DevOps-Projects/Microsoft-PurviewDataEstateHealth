...
class OKRSchema {
  val okrSchema: StructType = StructType(
    Array(
      ...
      StructField("OverallStatus", StringType, nullable = true),
      StructField("OverallProgress", IntegerType, nullable = true),
      StructField("OverallGoal", IntegerType, nullable = true),
      StructField("OverallMax", IntegerType, nullable = true),
      StructField("KeyResultsCount", IntegerType, nullable = true),
