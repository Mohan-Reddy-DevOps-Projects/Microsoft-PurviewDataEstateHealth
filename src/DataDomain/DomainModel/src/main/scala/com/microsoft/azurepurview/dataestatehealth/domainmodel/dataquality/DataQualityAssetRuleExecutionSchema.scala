...
class DataQualityAssetRuleExecutionSchema  {
  val dataQualityAssetRuleExecutionSchema: StructType = StructType(
    Array(
      ...
      StructField("AssetResultScore", DecimalType (18, 10), nullable = true),
