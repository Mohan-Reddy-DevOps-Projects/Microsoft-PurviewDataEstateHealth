  ...
  def main(args: Array[String],spark:SparkSession,ReProcessingThresholdInMins:Int): Unit = {
    try{
      ...
      if (args.length >= 5 && coldStartSoftCheck.validateCheckIn(args(0),"dataqualityv2fact")) {
        ...
        writer.overWriteData(df_dataQualityRuleTypeProcessed,adlsTargetDirectory,"DataQualityRuleType",ReProcessingThresholdInMins)
        ...
        dataQualityJobExecution.writeData(df_dataQualityJobExecutionProcessed,adlsTargetDirectory,refreshType,ReProcessingThresholdInMins)
        ...
        dataQualityRuleColumnExecution.writeData(df_dataQualityRuleColumnExecutionProcessed,adlsTargetDirectory,refreshType,ReProcessingThresholdInMins)
        ...
        dataQualityAssetRuleExecution.writeData(df_dataQualityAssetRuleExecutionProcessed,adlsTargetDirectory,refreshType,ReProcessingThresholdInMins)
        ...
        writer.overWriteData(df_dataQualityRuleProcessed,adlsTargetDirectory,"DataQualityRule",ReProcessingThresholdInMins)
