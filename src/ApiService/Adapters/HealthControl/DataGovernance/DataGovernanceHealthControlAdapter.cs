...
/// </summary>
[ModelAdapter(typeof(DataGovernanceHealthControlModel), typeof(DataGovernanceHealthControl))]
public class DataGovernanceHealthControlAdapter : BaseModelAdapter<DataGovernanceHealthControlModel, DataGovernanceHealthControl>
{
    /// <inheritdoc />
    public override DataGovernanceHealthControlModel ToModel(DataGovernanceHealthControl resource)
    {
        return new DataGovernanceHealthControlModel
        {
            Properties = new Models.DataGovernanceHealthControlProperties
            {
                Id = resource.Id,
    ...
    /// <inheritdoc />
    public override DataGovernanceHealthControl FromModel(DataGovernanceHealthControlModel model)
    {
