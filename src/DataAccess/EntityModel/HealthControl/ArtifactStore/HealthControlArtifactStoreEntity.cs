...
namespace Microsoft.Azure.Purview.DataEstateHealth.DataAccess.EntityModel.HealthControl;
using System;
...
internal class HealthControlArtifactStoreEntity : ArtifactStoreEntity
{
    public override DataEstateHealthEntityTypes GetEntityType() => DataEstateHealthEntityTypes.DataHealthEstateControl;
