...
public interface IAccountExposureControlConfigProvider
{
    ...
    /// <summary>
    /// Determines if DEH new controls flow is enabled. By default this is false.
    /// </summary>
    /// <param name="accountId"></param>
    /// <param name="subscriptionId"></param>
    /// <param name="tenantId"></param>
    ...
    /// <summary>
    /// Determines if DEH Control Redesign Billing improvements is enabled. By default this is false.
    /// </summary>
    /// <param name="accountId"></param>
    /// <param name="subscriptionId"></param>
    /// <param name="tenantId"></param>
