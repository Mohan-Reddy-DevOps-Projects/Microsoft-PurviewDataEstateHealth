...
internal class DataAccessEventsProcessingStage : IJobCallbackStage
{
    ...
    public DataAccessEventsProcessingStage(
        IServiceScope scope,
    ...
    public string StageName => nameof(DataAccessEventsProcessingStage);
    ...
    public async Task<JobExecutionResult> Execute()
    {
        ...
        try
        {
            processor = this.eventProcessorFactory.Build(EventSourceType.DataAccess);
        ...
        finally
        {
            ...
            this.metadata.DataAccessEventsProcessed = true;
        }
    ...
    {
        return this.metadata.DataAccessEventsProcessed;
    }
