...
internal class DataEstateHealthFabricDataWarehouseProvisioningStage : IJobCallbackStage
{
    ...
    public DataEstateHealthFabricDataWarehouseProvisioningStage(
        IServiceScope scope,
    ...
    public bool IsStagePreconditionMet()
    {
        ...
        * if yes then set this.metadata.IsDataWarehouseProvisioned = true;
    ...
    {
        /***
         * 1. call fabric api to provision data warehouse.
         * 2. if workspace is successfully created then set this.metadata.DataWarehouseId value returned by fabric and
         *      this.metadata.IsDataWarehouseProvisioned = true;
    ...
    {
        return this.metadata.IsDataWarehouseProvisioned;
    }
