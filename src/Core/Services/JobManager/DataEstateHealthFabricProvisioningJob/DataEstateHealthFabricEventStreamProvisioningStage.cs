...
internal class DataEstateHealthFabricEventStreamProvisioningStage : IJobCallbackStage
{
    ...
    public DataEstateHealthFabricEventStreamProvisioningStage(
        IServiceScope scope,
    ...
    public bool IsStagePreconditionMet()
    {
        ...
        * if yes then set this.metadata.IsEventStreamProvisioned = true;
    ...
    {
        /***
         * 1. call fabric api to provision event stream.
         * 2. if workspace is successfully created then set this.metadata.EventStreamId value returned by fabric and
         *      this.metadata.IsEventStreamProvisioned = true;
    ...
    {
        return this.metadata.IsEventStreamProvisioned;
    }
