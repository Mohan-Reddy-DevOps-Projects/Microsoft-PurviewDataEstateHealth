...
using Microsoft.Azure.Purview.DataEstateHealth.Core.Services.JobManager.MonitoringJobs;
...
internal class BackgroundJobMonitoringCallbackJob : StagedWorkerJobCallback<StagedWorkerJobMetadata>
{
    ...
    /// <inheritdoc />
    protected override string JobName => nameof(BackgroundJobMonitoringCallbackJob);

    protected override bool IsRecurringJob => true;

    public BackgroundJobMonitoringCallbackJob(IServiceScope scope)
        : base(scope)
    {
    ...
    protected override void OnJobConfigure()
    {
        ...
        {
            new MonitorSparkPoolCountStage(this.Scope, this.JobManagement),
        };
    }
